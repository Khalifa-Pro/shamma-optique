...
class ProduitController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'categorie'     => 'required|in:monture_adulte,monture_enfant,monture_solaire,verre_unifocal,verre_progressif,verre_degressif,lentille,produit_entretien,accessoire,autre',
